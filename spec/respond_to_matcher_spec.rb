class HotChocolate
  ...
  def purchase(number)
    "Awesome, I just purchased #{nubmer} more hot chocolate beverages!"
  end
end

RSpec.describe HotChocolate do
  it 'confirms that an objet can respond to a methods' do
    expect(subject).to respond_to(:drink)
    expect(subject).to respond_to(:drink, :discard)
    expect(subject).to respond_to(:drink, :discard, :purchase)
  end

  it 'confirms an objet can respond to a method with arguments' do
